...
export default {
    ...
    callback: async ({ message, interaction, guild, user, text}) => {
        ...
        if (!Timestamp) return `<:Fail:929607022675120239> Not Able to Find Timestamp `;
        ...
        return {
            custom: true,
            embeds: [ new MessageEmbed().setColor('GREEN')
            .setDescription(`<:Success:929606936977084427> Your Afk Has Been Set Successfully! \n message: ${text}`) ],
            ephemeral: true,
